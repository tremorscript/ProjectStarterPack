...
Replacement of special characters and symbols occur in all inline and block elements except for comments and passthroughs.
...
|Sam\&#9217;s
|Sam's
|The vertical form apostrophe is replace with the curved form apostrophe
